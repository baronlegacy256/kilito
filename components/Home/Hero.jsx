...
function Hero() {
  return (
    <div><div id="top-inline-zone" className="top-inline-zone background-zone-image"
    ...
    <div className="top-zone-inner">
        <h1 id="content-title" className="">
            ...
            <div className="content-title-part-1">
...
Kili to Savanna
        ...
        <div className="sport-rating-zone">
            ...
            <Link href="/#opinion-zone" className="no-decoration">
                ...
                <i className="rating-icon fa fa-star active" aria-hidden="true"></i>
            ...
            <div className="custom-breadcrumb">
                <ul itemScope itemType="http://schema.org/BreadcrumbList">
                    <li itemProp="itemListElement" itemScope itemType="http://schema.org/ListItem">
                        ...
                        <span>
                            <img src="/assets/picto_logo_white-cb2aff7b5b54faf3c9eeb095ee529509.svg"
